...
V2s = linspace(1.5, 2.5, numV2s).tolist()
...
sio.savemat("pFET-VbBelowThresh-Vout1.mat", mdict={'VbBelowThresh': VbBelowThresh})
...
sio.savemat("pFET-VbBelowThresh-Vout2.mat", mdict={'VbBelowThresh': VbBelowThresh})
...
sio.savemat("pFET-VbAboveThresh-Vout1.mat", mdict={'VbAboveThresh': VbAboveThresh})
...
sio.savemat("pFET-VbAboveThresh-Vout2.mat", mdict={'VbAboveThresh': VbAboveThresh})
